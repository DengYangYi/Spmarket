# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-09-28 14:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sp_user.User', verbose_name='创建人')),
            ],
            options={
                'verbose_name': '收货地址管理',
        ...
        migrations.AddField(
            model_name='orderinfo',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sp_user.User', verbose_name='所属用户'),
        ),
        migrations.AddField(
