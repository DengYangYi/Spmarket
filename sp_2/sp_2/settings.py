"""
Django settings for sp_2 project.
...
SECRET_KEY = '0_ei7+rfhgy_2u))6hun9v9#mf5ub4zo3^x0sy*qfbq-=&f0qz'
...
WSGI_APPLICATION = 'sp_2.wsgi.application'
...
# ckeditor 单独配置
CKEDITOR_UPLOAD_PATH = "ck_upload/"  # 配置上传目录斜线不能少
# 编辑器样式配置
CKEDITOR_CONFIGS = {
	'default': {
		'toolbar': 'full',
